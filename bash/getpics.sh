...
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.zip http://zonzorp.net/pics.zip
#########################

#unpack the tarfile and remove it if successful
test -f ~/Pictures/pics.tgz && tar -xvf  ~/Pictures/pics.tgz -C ~/Pictures && rm ~/Pictures/pics.zip
########################
